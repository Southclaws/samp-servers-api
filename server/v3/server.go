...
func (v *V3) serverAdd(w http.ResponseWriter, r *http.Request) {
...
func (v *V3) serverPost(w http.ResponseWriter, r *http.Request) {
...
func (v *V3) serverGet(w http.ResponseWriter, r *http.Request) {
	address, ok := mux.Vars(r)["address"]
	if !ok {
		WriteError(w, http.StatusBadRequest, errors.New("no address specified"))
	}
